...
namespace game
{
	LandEnemy CreateVehicle(LandVehicles& landVehicles, LandEnemy& landEnemy)
	{
		switch (landVehicles)
		{
			case game::LandVehicles::Motorcycle:
			...
			case game::LandVehicles::FastCar:
